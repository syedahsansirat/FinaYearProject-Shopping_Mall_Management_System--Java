...
public class PreViewTenant extends javax.swing.JFrame {
    ...
    public PreViewTenant() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                model.addRow(new Object[]{serial, tenantId, tenantName, tenantOccupation, availablity});
                serial++;
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void initComponents() {
        ...
        EnterIdLabel.setText("Select Raw From Table to View Details :");
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial", "ID", "Name", "Occupation", "Took Rent"
            }
        ));
